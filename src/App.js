...
const [eAssetMintMessage, setEAssetMintMessage] = useState("");
  ...
  const pageDesc = activeTab === "Trade" 
    ? "Coffhee's Dark Pools are automated portfolio managers that continuously monitors and rebalances assets without revealing the underlying strategy to the market."
