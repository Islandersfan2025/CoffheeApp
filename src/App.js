...
const [eAssetMintMessage, setEAssetMintMessage] = useState("");
  ...
  const pageDesc = activeTab === "Trade" 
    ? "Coffhee's Dark Pools are an automated portfolio manager that continuously monitors and rebalances assets without revealing the underlying strategy to the market."
